...
import com.avbravo.jmoordbcorecomponent.utils.Tiempo;
...
// </editor-fold>
    ...
    public static Integer mesDeUnaFechaStartEneroWith1(Date date) {
        ...
        try {
            ...
            FacesUtil.showError( "getMesDeUnaFechaStartEneroWith1() " + e.getLocalizedMessage());
        }
        return 0;
...
// </editor-fold>
    ...
    public static List<FechaDiaUtils> nameOfDayOfDateOfMonth(Integer year, String mes) {
        ...
        try {
            ...
            showError("nameOfDayOfDateOfMonth() " + e.getLocalizedMessage());
        }
...
// <editor-fold defaultstate="collapsed" desc="Integer minutosEntreFechas(Date fechaMayor, Date fechaMenor)"> 
    ...
    public static Boolean fechaMenor(Date date1, Date date2) {
        ...
        try {
            ...
            FacesUtil.showError( "fechaMenor() " + e.getLocalizedMessage());
        }
        return esmenor;
    }
    // </editor-fold>
    ...
    public static Boolean fechaMayor(Date date1, Date date2) {
        ...
        try {
            ...
            FacesUtil.showError("fechaMayor() " + e.getLocalizedMessage());
        }
        return esmenor;
    }
    // </editor-fold>
    ...
    public static Boolean fechaIgual(Date date1, Date date2) {
        ...
        try {
            ...
            FacesUtil.showError( "fechaIgual() " + e.getLocalizedMessage());
        }
        return esmenor;
    }
    // </editor-fold>
...
// <editor-fold defaultstate="collapsed" desc="sumarMesaFechaActual"> 
    ...
    public static Date sumarMesaFecha(Date date, Integer mes) {
        ...
        try {
            ...
            showError("sumarMesaFecha() " + e.getLocalizedMessage());
        }
        return dateresult;
    }// </editor-fold>
...
// </editor-fold>
    ...
    public static String milisegundosToTiempoString(long milisegundos) {
        ...
        try {
            ...
            showError("milisegundosToTiempoString() " + e.getLocalizedMessage());
        }
        return tiempoString;
...
// </editor-fold>
    ...
    public static Integer numberOfMonthBetweenDecomposedDate(DecomposedDate start, DecomposedDate end) {
        ...
        try {
            ...
            showError("numeroMesesEntreFechas() " + e.getLocalizedMessage());
        }
        return meses;
    }
    // </editor-fold>
...
//convertir la fecha de solicitud a LocalDate
    ...
    public String showDateLocalDate(LocalDate date) {
        ...
        try {
            ...
            FacesUtil.showError("showDateLocalDate()" + e.getLocalizedMessage());
        }
