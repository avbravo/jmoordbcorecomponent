...
// </editor-fold>
    ...
    public BoxMenu add(MenuItem menuItem) {
        try {
            ...
            sb.append("            " + Draw.image(menuItem.getImageLibrary(),menuItem.getImageName(),menuItem.getImageContextRoot()));
            sb.append("        </i>\n");
    ...
    public BoxMenu add(SubMenu subMenu) {
        try {
            ...
            sb.append("        <i class=\"icon\">\n");
             sb.append("            " + Draw.image(subMenu.getImageLibrary(),subMenu.getImageName(), subMenu.getImageContextRoot()));
                  sb.append("        </i>\n");
